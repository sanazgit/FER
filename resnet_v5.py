...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=7, zero_init_residual=False,
        ...
        # self.avg_pool_3 = nn.AdaptiveAvgPool2d((1, 1))
        # self.fc_1 = nn.Linear(256, 7)
        # self.fc_2 = nn.Linear(256, 7)
        # self.fc_3 = nn.Linear(256, 7)
        self.avgpool = nn.AdaptiveAvgPool2d((1, 1))
        # self.fc_1 = nn.Linear(256*3, 256)
        # self.fc_1 = nn.Linear(512 * block.expansion, 64)
    ...
    def _forward_impl(self, x):
        ...
        # x_3 = self.relu(x_3)
        # 7*7*512*3
        x_fc1 = self.avgpool(x_1)
        x_fc2 = self.avgpool(x_2)
        x_fc3 = self.avgpool(x_3)
        # 1*1*512*3
        x_fc1 = torch.flatten(x_fc1, 1)
        x_fc2 = torch.flatten(x_fc2, 1)
        x_fc3 = torch.flatten(x_fc3, 1)
        # # 512*3
        ...
        # fc
        # x_fc1 = self.fc_1(x_fc1)
        # x_fc2 = self.fc_2(x_fc2)
        # x_fc3 = self.fc_3(x_fc3)

        # l_12 = torch.matmul(x_fc1, x_fc2)
        # l_13 = torch.matmul(x_fc1, x_fc3)
        # l_23 = torch.matmul(x_fc2, x_fc3)
        # x_1 = x_1 * x_fc1
        # x_2 = x_2 * x_fc2
        # x_3 = x_3 * x_fc3
        ...
        # x = torch.cat([x_fc1, x_fc2], dim=1)
        # x = torch.cat([x, x_fc3], dim=1)
        # 不行
        # x = x_fc1 + x_fc2
        # x = x + x_fc3
        ...
        return x_1, x_2, x_3, x_fc1, x_fc2, x_fc3, x
