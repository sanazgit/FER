...
class ResNet_Pose(nn.Module):
    ...
    def __init__(self, block, layers, rect=None, rect_local=None, num_classes=7, zero_init_residual=False,
        ...
        self.ap_layer = self._cso_layer(CSO_AttentionBlock , 512, 256, 2, stride=2)                               
        ...
        self.fc_2 = nn.Linear(256 * 5, 768)
        self.fc_2_1 = nn.Linear(768, num_classes)
    ...
    def _cso_layer(self, block, inplanes, planes, blocks, stride=1):
        norm_layer = self._norm_layer
        downsample = None
    ...
    def _global_module(self, x):
      ...
      # Flatten each tensor to prepare for concatenation
        ...
        return x_gl_fc1, x_gl_fc2, x_gl_fc3, out_gl
    ...
    def _ssr_module(self, x):
        ...
        mouth_out1 = self.ap_layer(mouth1)
        mouth_out2 = self.ap_layer(mouth2)
        ...
        # local
        out_sr = torch.cat([eye1_out_fc, eye2_out_fc, eye_midd_out_fc, mouth1_out_fc, mouth2_out_fc], dim=1)
 
        out_sr = self.fc_2(out_sr)
 
        out_sr = self.fc_2_1(out_sr)
    ...
    def _forward_impl(self, x):
     ...
     #... Residual Blocks
        ...
        x_gl_fc1, x_gl_fc2, x_gl_fc3, out_gl = self._global_module(x)
        out_sr = self._ssr_module(x)

        return x_gl_fc1, x_gl_fc2, x_gl_fc3,out_gl,out_sr
