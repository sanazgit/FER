...
class FusionAttentionNetwork(nn.Module):
    def __init__(self):
        ...
        # Feature branches
        self.branch1 = FeatureBranch(512, 128)
        self.branch2 = FeatureBranch(512, 128)
        self.branch3 = FeatureBranch(512, 128)
...
class ResNet_Pose(nn.Module):
    ...
    def __init__(self, block, layers, rect=None, rect_local=None, num_classes=7, zero_init_residual=False,
        ...
        self.conv2_1 = nn.Conv2d(512 * block.expansion, 128, kernel_size=1)
        self.conv2_2 = nn.Conv2d(512 * block.expansion, 128, kernel_size=1)
        self.conv2_3 = nn.Conv2d(512 * block.expansion, 128, kernel_size=1)
    ...
    def _forward_impl(self, x):
     ...
     #... Residual Blocks
        ...
        return x_gl_1,x_gl_2,x_gl_3, x_fa_1,x_fa_2,x_fa_3, x_gl_fc1,x_gl_fc2,x_gl_fc3,x_fa_fc1,x_fa_fc2,x_fa_fc3, out_gl, out_sr
